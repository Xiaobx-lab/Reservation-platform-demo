	...
	<body>
		<div class="container">
			...
			<div class="row">
				...
				<form action="${path}/order.action" method = "get">
					<div class="content-content">
						<div class="box">
							...
							<div class="content-input">
								<input class="in" type="text" autocomplete="off" name="user"/>
						...
						<div class="box">
							...
							<div>
								男：<input type="radio" autocomplete="off" name="sex" value="男"/>
								女：<input type="radio" autocomplete="off" name="sex" value="女"/>
						...
						<div class="box">
							...
							<div class="content-input">
								<input class="in" type="tel" autocomplete="off" name="phone" />
						...
						<div class="box">
							...
							<div class="content-input">
								<input class="in" type="tel" autocomplete="off" name="address"/>
						...
						<div class="box">
							...
							<div >
								<textarea id="textarea" name="note" class="content-input" style="height: 45px;outline: none;" autocomplete="off">请留言</textarea>
							</div>						
						</div>
						<div class="box2">
							<input type="submit" class="box-button" value="提&nbsp;&nbsp;&nbsp;交" />
						</div>
						<div class="box2">
							<input type="submit" class="box-button" onclick="reset()" value="重&nbsp;&nbsp;&nbsp;置" />
						</div>
					</div>
				</form>
			</div>
